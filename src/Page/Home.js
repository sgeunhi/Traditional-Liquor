    ...
    <div>
      ...
      <main>
        ...
        <div className="latest-news">
          ...
          <h1 style={{fontSize :"200%"}}><span style={{fontWeight:"bold"}}>뉴스</span>에 소개된 우리의 <span style={{fontWeight:"bold"}}>전통주</span></h1>
          <div className="news-wrapper">
            <div className="news">
              <img src={newsThumbnail_1} onClick={() => window.open("https://bravo.etoday.co.kr/view/atc_view.php?varAtcId=13615")} className="news-image"/>
              <span><a href="https://bravo.etoday.co.kr/view/atc_view.php?varAtcId=13615">[카드뉴스] 문헌 밖으로 나온 ‘전설의 전통주’</a></span>
            </div>
            <div className="news">
              <img src={newsThumbnail_2} onClick={() => window.open("https://biz.chosun.com/distribution/channel/2022/05/24/NKCSKQ7HEFEJZCD2JKGEHCUNE4/?utm_source=naver&utm_medium=original&utm_campaign=biz")} className="news-image"/>
              <span><a href="https://biz.chosun.com/distribution/channel/2022/05/24/NKCSKQ7HEFEJZCD2JKGEHCUNE4/?utm_source=naver&utm_medium=original&utm_campaign=biz">세븐일레븐 ‘토끼소주’ 판매...편의점 고급소주 경쟁 본격화</a></span>
            </div>
        ...
        <h1 style={{fontSize:"200%"}} id="liquor-card-wrapper-text"><span style={{fontWeight:"bold"}}>전통주</span> 둘러보기</h1>
